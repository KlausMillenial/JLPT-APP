    ...
    examples: [
      {
        ...
        german: "Ich schätze die Familie.",
        spanish: "Valoro la familia.",
        chinese: "我会珍惜家庭。",
        korean: "가정을 소중히 여깁니다.",
        vietnamese: "Tôi coi trọng gia đình.",
      },
    ...
    examples: [
      {
        ...
        german: "Bitte biegen Sie an der Ecke nach rechts ab.",
        spanish: "Gire a la derecha en la esquina.",
        chinese: "请向右转弯。",
        korean: "모퉁이를 오른쪽으로 돌아주세요.",
        vietnamese: "Xin hãy rẽ phải ở góc.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        french: "J'ai acheté un nouveau sac.",
        german: "Ich habe eine neue Tasche gekauft.",
        spanish: "He comprado una nueva bolsa.",
        chinese: "我买了一个新包。",
        korean: "새 가방을 샀습니다.",
        vietnamese: "Tôi đã mua một chiếc túi mới.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        chinese: "我把花放进了花瓶里。",
        korean: "꽃병에 꽃을 넣었습니다.",
        vietnamese: "Tôi đã cho hoa vào bình.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Bitte schreiben Sie Ihren Namen auf das Papier.",
        spanish: "Por favor, escribe tu nombre en el papel.",
        chinese: "请在纸上写下名字。",
        korean: "종이에 이름을 써 주세요.",
        vietnamese: "Hãy viết tên của bạn lên giấy.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        french: "Le curry est épicé.",
        german: "Curry ist scharf.",
        spanish: "El curry es picante.",
        chinese: "咖喱很辣。",
        korean: "카레는 맵습니다.",
        vietnamese: "Cà ri thì cay.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        chinese: "请注意身体。",
        korean: "몸 조심하세요.",
        vietnamese: "Hãy chăm sóc sức khỏe của bạn.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Ich habe ein Buch von einem Freund ausgeliehen.",
        spanish: "Tomé prestado un libro de un amigo.",
        chinese: "我从朋友那里借了一本书。",
        korean: "친구에게서 책을 빌렸습니다.",
        vietnamese: "Tôi đã mượn sách từ bạn.",
      },
    ]
  },
    ...
    examples: [
      {
        ...
        spanish: "Esta bolsa es ligera.",
        chinese: "这个包很轻。",
        korean: "이 가방은 가볍습니다.",
        vietnamese: "Cái túi này nhẹ.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Ich mache Curry.",
        spanish: "Voy a hacer curry.",
        chinese: "我会做咖喱。",
        korean: "카레를 만들겠습니다.",
        vietnamese: "Tôi sẽ nấu cà ri.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Ich hänge den Kalender an die Wand.",
        spanish: "Colgaré el calendario en la pared.",
        chinese: "把日历挂在墙上。",
        korean: "달력을 벽에 걸어둡니다.",
        vietnamese: "Treo lịch lên tường.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Ich fange Fische im Fluss.",
        spanish: "Pesco peces en el río.",
        chinese: "在河里钓鱼。",
        korean: "강에서 물고기를 잡습니다.",
        vietnamese: "Tôi câu cá ở sông.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Die Katze ist sehr süß.",
        spanish: "Ese gato es muy lindo.",
        chinese: "那只猫非常可爱。",
        korean: "그 고양이는 매우 귀엽습니다.",
        vietnamese: "Con mèo đó rất dễ thương.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        french: "J'étudie les kanjis.",
        german: "Ich lerne Kanji.",
        spanish: "Estoy estudiando kanji.",
        chinese: "我在学习汉字。",
        korean: "한자를 공부하고 있습니다.",
        vietnamese: "Tôi đang học kanji.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        spanish: "Hay un árbol grande en el jardín.",
        chinese: "院子里有一棵大树。",
        korean: "정원에 큰 나무가 있습니다.",
        vietnamese: "Trong vườn có một cái cây lớn.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Es blühen gelbe Blumen.",
        spanish: "Están floreciendo flores amarillas.",
        chinese: "黄色的花正在盛开。",
        korean: "노란 꽃이 피어 있습니다.",
        vietnamese: "Hoa màu vàng đang nở.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        spanish: "Se ha apagado la luz.",
        chinese: "电力消失了。",
        korean: "전기가 꺼졌습니다.",
        vietnamese: "Điện đã tắt.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        english: "I ask the teacher a question.",
        french: "Je pose une question au professeur.",
        german: "Ich werde dem Lehrer eine Frage stellen.",
        spanish: "Voy a hacerle una pregunta al profesor.",
        chinese: "我会向老师提问。",
        korean: "선생님께 질문을 하겠습니다.",
        vietnamese: "Tôi sẽ hỏi giáo viên một câu hỏi.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Im Norden Japans liegt Hokkaido.",
        spanish: "Al norte de Japón se encuentra Hokkaido.",
        chinese: "日本的北边有北海道。",
        korean: "일본의 북쪽에는 홋카이도가 있습니다.",
        vietnamese: "Ở phía bắc của Nhật Bản có Hokkaido.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Ich habe mit einem Freund in einem Café gesprochen.",
        spanish: "Hablé con un amigo en una cafetería.",
        chinese: "我在咖啡店和朋友聊天。",
        korean: "카페에서 친구와 이야기했습니다.",
        vietnamese: "Tôi đã nói chuyện với bạn bè ở quán cà phê.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Bitte geben Sie mir zehn Briefmarken.",
        spanish: "Dame diez sellos, por favor.",
        chinese: "请给我十张邮票。",
        korean: "우표를 열 장 주세요.",
        vietnamese: "Xin cho tôi mười con tem.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Ich kaufe ein Zugticket.",
        spanish: "Voy a comprar un billete de tren.",
        chinese: "我买火车票。",
        korean: "전철 표를 삽니다.",
        vietnamese: "Tôi sẽ mua vé tàu.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Ich stehe um neun Uhr auf.",
        spanish: "Me levanto a las nueve.",
        chinese: "我九点起床。",
        korean: "아홉 시에 일어납니다.",
        vietnamese: "Tôi dậy lúc chín giờ.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Ich esse oft Rindfleisch.",
        spanish: "Como mucha carne de res.",
        chinese: "我经常吃牛肉。",
        korean: "소고기를 자주 먹습니다.",
        vietnamese: "Tôi thường ăn thịt bò.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        spanish: "Bebo leche todas las mañanas.",
        chinese: "我每天早上喝牛奶。",
        korean: "매일 아침 우유를 마십니다.",
        vietnamese: "Mỗi sáng tôi uống sữa.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        english: "I am busy today.",
        french: "Je suis occupé aujourd'hui.",
        german: "Heute bin ich beschäftigt.",
        spanish: "Hoy estoy ocupado.",
        chinese: "今天很忙。",
        korean: "오늘은 바쁩니다.",
        vietnamese: "Hôm nay tôi bận.",
    ...
    examples: [
      {
        ...
        german: "Ich lerne im Klassenzimmer.",
        spanish: "Estudio en el aula.",
        chinese: "在教室里学习。",
        korean: "교실에서 공부합니다.",
        vietnamese: "Tôi học trong lớp học.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        spanish: "El año pasado fui a Japón.",
        chinese: "去年我去了日本。",
        korean: "작년에 일본에 갔습니다.",
        vietnamese: "Năm ngoái tôi đã đi Nhật Bản.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        english: "I cut paper.",
        french: "Je coupe du papier.",
        german: "Ich schneide das Papier.",
        spanish: "Corto papel.",
        chinese: "我会剪纸。",
        korean: "종이를 자릅니다.",
        vietnamese: "Tôi cắt giấy.",
    ...
    examples: [
      {
        ...
        german: "Ich ziehe eine Jacke an.",
        spanish: "Me pongo una chaqueta.",
        chinese: "我会穿上夹克。",
        korean: "재킷을 입습니다.",
        vietnamese: "Tôi sẽ mặc áo khoác.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Dieser Raum ist sauber.",
        spanish: "Esta habitación está limpia.",
        chinese: "这个房间很干净。",
        korean: "이 방은 깨끗합니다.",
        vietnamese: "Căn phòng này sạch sẽ.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Ich habe 2 Kilogramm Äpfel gekauft.",
        spanish: "Compré 2 kilos de manzanas.",
        chinese: "我买了2公斤苹果。",
        korean: "사과를 2킬로 샀습니다.",
        vietnamese: "Tôi đã mua 2 kg táo.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Es sind 1 Kilometer bis zum Bahnhof.",
        spanish: "La estación está a un kilómetro.",
        chinese: "到车站有1公里。",
        korean: "역까지 1킬로미터입니다.",
        vietnamese: "Từ đây đến ga là 1 kilômét.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Ich hebe Geld von der Bank ab.",
        spanish: "Voy a retirar dinero del banco.",
        chinese: "我在银行取钱。",
        korean: "은행에서 돈을 인출합니다.",
        vietnamese: "Tôi sẽ rút tiền ở ngân hàng.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Ich gehe am Freitag ins Kino.",
        spanish: "Voy a ir a ver una película el viernes.",
        chinese: "我星期五去看电影。",
        korean: "금요일에 영화를 보러 갈 거예요.",
        vietnamese: "Tôi sẽ đi xem phim vào thứ Sáu.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        english: "I take medicine.",
        french: "Je prends un médicament.",
        german: "Ich nehme Medikamente.",
        spanish: "Tomaré la medicina.",
        chinese: "我会吃药。",
        korean: "약을 먹습니다.",
        vietnamese: "Tôi sẽ uống thuốc.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Bitte geben Sie mir Wasser.",
        spanish: "Por favor, dame agua.",
        chinese: "请给我水。",
        korean: "물 주세요.",
        vietnamese: "Xin hãy cho tôi nước.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        spanish: "Como frutas todos los días.",
        chinese: "我每天吃水果。",
        korean: "나는 매일 과일을 먹습니다.",
        vietnamese: "Tôi ăn trái cây mỗi ngày.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        french: "Ouvrez la bouche, s'il vous plaît.",
        german: "Bitte öffnen Sie den Mund.",
        spanish: "Por favor, abra la boca.",
        chinese: "请张嘴。",
        korean: "입을 벌려 주세요.",
        vietnamese: "Xin hãy mở miệng ra.",
      },
    ...
    examples: [
      {
        ...
        french: "J'ai acheté de nouvelles chaussures.",
        german: "Ich habe neue Schuhe gekauft.",
        spanish: "He comprado unos zapatos nuevos.",
        chinese: "我买了新鞋子。",
        korean: "새 신발을 샀습니다.",
        vietnamese: "Tôi đã mua một đôi giày mới.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        french: "Je mets des chaussettes.",
        german: "Ich ziehe Socken an.",
        spanish: "Me pongo los calcetines.",
        chinese: "我穿上袜子。",
        korean: "양말을 신습니다.",
        vietnamese: "Tôi sẽ đi tất.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Japan ist ein sehr schönes Land.",
        spanish: "Japón es un país muy hermoso.",
        chinese: "日本是一个非常美丽的国家。",
        korean: "일본은 매우 아름다운 나라입니다.",
        vietnamese: "Nhật Bản là một đất nước rất đẹp.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Der Himmel hat sich bewölkt.",
        spanish: "El cielo se ha nublado.",
        chinese: "天空开始变得阴云密布。",
        korean: "하늘이 흐려졌습니다.",
        vietnamese: "Trời đã bắt đầu có mây.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Hast du gefrühstückt?",
        spanish: "¿Has desayunado?",
        chinese: "你吃早餐了吗？",
        korean: "아침을 먹었나요?",
        vietnamese: "Bạn đã ăn sáng chưa?",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Bitte wischen Sie die Tafel ab.",
        spanish: "Por favor, borra la pizarra.",
        chinese: "请擦黑板。",
        korean: "칠판을 지워주세요.",
        vietnamese: "Hãy xóa bảng đen.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Das ist in Ordnung.",
        spanish: "Está bien así.",
        chinese: "这样就可以了。",
        korean: "그것으로 괜찮습니다.",
        vietnamese: "Vậy là đủ rồi.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Die beiden haben geheiratet.",
        spanish: "Los dos se casaron.",
        chinese: "两人结婚了。",
        korean: "두 사람은 결혼했습니다.",
        vietnamese: "Hai người đã kết hôn.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Die Arbeit beginnt am Montag.",
        spanish: "El trabajo comienza el lunes.",
        chinese: "从星期一开始工作。",
        korean: "월요일부터 일이 시작됩니다.",
        vietnamese: "Công việc sẽ bắt đầu từ thứ Hai.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Ich ziehe die Schuhe im Eingangsbereich aus.",
        spanish: "Me quito los zapatos en la entrada.",
        chinese: "我在玄关脱鞋。",
        korean: "신발을 현관에서 벗습니다.",
        vietnamese: "Tôi sẽ cởi giày ở cửa ra vào.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Ich mache einen Spaziergang im Park.",
        spanish: "Voy a dar un paseo en el parque.",
        chinese: "我在公园散步。",
        korean: "공원에서 산책합니다.",
        vietnamese: "Tôi sẽ đi dạo trong công viên.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        spanish: "Bebo té negro todas las mañanas.",
        chinese: "我每天早上喝红茶。",
        korean: "매일 아침 홍차를 마십니다.",
        vietnamese: "Mỗi sáng tôi uống trà đen.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Ihre Stimme ist schön.",
        spanish: "Su voz es hermosa.",
        chinese: "她的声音很美。",
        korean: "그녀의 목소리는 아름답습니다.",
        vietnamese: "Giọng của cô ấy rất đẹp.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Bitte einen Kaffee.",
        spanish: "Por favor, dame una taza de café.",
        chinese: "请给我一杯咖啡。",
        korean: "커피 한 잔 주세요.",
        vietnamese: "Cho tôi một ly cà phê.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Bitte setzen Sie sich hier.",
        spanish: "Por favor, siéntate aquí.",
        chinese: "请坐在这里。",
        korean: "여기 앉아 주세요.",
        vietnamese: "Xin hãy ngồi ở đây.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Lass uns um 15 Uhr treffen.",
        spanish: "Nos vemos a las 3 de la tarde.",
        chinese: "下午3点见。",
        korean: "오후 3시에 만나요.",
        vietnamese: "Hẹn gặp lúc 3 giờ chiều.",
      },
    ...
    examples: [
      {
        ...
        german: "In diesem Jahr gehe ich nach Japan.",
        spanish: "Este año iré a Japón.",
        chinese: "今年我去日本。",
        korean: "올해 일본에 갑니다.",
        vietnamese: "Năm nay tôi sẽ đi Nhật Bản.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Ich lerne neue Wörter.",
        spanish: "Aprenderé nuevas palabras.",
        chinese: "我会记住新词。",
        korean: "새로운 말을 배웁니다.",
        vietnamese: "Tôi sẽ học từ mới.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        chinese: "孩子们在公园里玩。",
        korean: "아이들이 공원에서 놀고 있습니다.",
        vietnamese: "Trẻ em đang chơi ở công viên.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        chinese: "下次一起去吧。",
        korean: "다음에 함께 가요.",
        vietnamese: "Lần tới hãy đi cùng nhau nhé.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "So ein Buch möchte ich nicht lesen.",
        spanish: "No quiero leer un libro así.",
        chinese: "我不想读这样的书。",
        korean: "이런 책은 읽고 싶지 않아.",
        vietnamese: "Tôi không muốn đọc cuốn sách như thế này.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Bitte zeigen Sie auf die Karte.",
        spanish: "Por favor, señala el mapa.",
        chinese: "请指一下地图。",
        korean: "지도를 가리켜 주세요.",
        vietnamese: "Xin hãy chỉ vào bản đồ.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        german: "Ich habe drei Äpfel gegessen.",
        spanish: "Comí tres manzanas.",
        chinese: "我吃了三个苹果。",
        korean: "사과를 세 개 먹었습니다.",
        vietnamese: "Tôi đã ăn ba quả táo.",
      },
    ]
  },
{
    ...
    examples: [
      {
        ...
        french: "Je me promène dans le parc.",
        german: "Ich gehe im Park spazieren.",
        spanish: "Voy a pasear por el parque.",
        chinese: "我在公园散步。",
        korean: "공원을 산책합니다.",
    ...
    examples: [
      {
        ...
        german: "Der Hund ist gestorben.",
        spanish: "Ese perro ha muerto.",
        chinese: "那只狗死了。",
        korean: "그 개는 죽었습니다.",
        vietnamese: "Con chó đó đã chết.",
      },
    ]
  },
{
